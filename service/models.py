...
class RepairRequest(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name="created_requests",null=True,blank=True)
...
class Updaterepairstatus(models.Model):
   ...
   estimation=models.ForeignKey(Estimation,on_delete=models.CASCADE,related_name="updates",null=True,blank=True)
...
class Invoice(models.Model):
    estimation=models.OneToOneField(Estimation,on_delete=models.CASCADE,related_name="invoice",null=True,blank=True)
